        ...
        <section className='mb-5'>
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="md:flex grid grid-cols-2 overflow-auto scrollbar-none"
            >
              {navigationConfig[isClicked]?.dropdownItems.map((product, pIdx) => (
                ...
                >
                  ...
                  <div className="relative md:w-80 aspect-square rounded-xl overflow-hidden bg-zinc-950 mb-4 border border-zinc-900/50">
                    <Image
                      src={product.image}
                      alt={product.name}
                      fill
