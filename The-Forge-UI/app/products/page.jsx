...
export default function products()
{
  ...
  return(
    ...
    <motion.div animate={{y:[0,30,0], x:[10, 20,10]}} transition={{duration:2, ease: "easeInOut", repeat: Infinity}} className='font-extrabold mb-10 text-blue-300  px-5 text-3xl md:text-8xl flex gap-2'>BUY YOUR<h1 className='text-amber-500'>DREAM</h1> </motion.div> 
    <section className='bg-zinc-900  py-3 border border-zinc-700 rounded-xl flex gap-6 w-fill justify-center font-mono md:gap-40'>
